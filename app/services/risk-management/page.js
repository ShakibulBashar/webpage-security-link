...
export default function RiskManagementDivision() {
  const methodologySteps = [
    { num: "01", title: "Threat Analysis", desc: "Comprehensive threat assessments specific to your organization and geographical context." },
    { num: "02", title: "Physical Design", desc: "Integrated physical security solutions combining perimeter, access, and layered defense." },
    { num: "03", title: "Technology Assessment", desc: "Evaluation and recommendation of security technologies tailored to threat profile." },
    { num: "04", title: "Awareness Training", desc: "Security awareness programs for executives and staff ensuring informed personnel." }
  ];
      ...
      <div className="bg-obsidian-deep border-t border-surface-border px-6 md:px-12 py-4 sticky top-20 z-40">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-on-surface-variant">
            ...
            <span>/</span>
            <span className="text-cobalt-electric font-bold">Risk Management Division</span>
          </div>
        </div>
      </div>
          ...
          <div className="mb-32 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                Every asset faces a unique threat profile. A methodical security management approach helps organizations understand their likely threats, identify sources, track incidents, and quantify potential losses.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {methodologySteps.map((step, idx) => (
                ...
                >
                  ...
                  <h3 className="font-bold text-on-surface mb-3 uppercase tracking-wide">{step.title}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              ...
              <div className="order-1 md:order-2">
                ...
                <div className="space-y-6">
                  {[
                    { title: "Annual Security Audits", desc: "Comprehensive reviews identifying gaps and recommending improvements." },
                    { title: "Incident Analysis", desc: "Detailed review of security incidents extracting lessons and preventing recurrence." },
                    { title: "Adaptive Recommendations", desc: "Updated guidance based on changing threat landscapes and emerging technologies." }
                  ].map((item, idx) => (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-on-surface-variant text-lg leading-relaxed mb-8">
                  SecurityLink's Risk Management Division is staffed by certified security consultants with over 30 years of combined field experience. Our team has worked across diverse sectors and threat environments.
                </p>
                <div className="space-y-6">
                  {[
                    { title: "Certified Professionals", desc: "Recognized security certifications and current industry best practices." },
                    { title: "Sector Expertise", desc: "Experience protecting banking, manufacturing, corporate, and critical infrastructure." },
                    { title: "Proven Track Record", desc: "Security strategies tested and refined across decades of real-world application." }
                  ].map((item, idx) => (
                    <div key={idx} className="flex gap-4">
                      <span className="material-symbols-outlined text-cobalt-electric flex-shrink-0">verified</span>
                      <div>
      ...
      <section className="bg-obsidian-deep border-t border-surface-border py-20 md:py-32">
        <div className="max-w-4xl mx-auto px-6 md:px-12 text-center">
          ...
          <p className="text-on-surface-variant text-lg mb-12 leading-relaxed">
            Engage SecurityLink's Risk Management Division to develop a comprehensive, integrated security approach tailored to your organization's unique threat profile.
          </p>
